  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-16 text-sm leading-relaxed text-gray-700">
      ...
      <section className="mb-7">
        ...
        <p>
          회원 탈퇴를 요청하시면 지체 없이 파기합니다. 현재 서비스 내 회원 탈퇴 기능은 준비
          중이며, 탈퇴 및 개인정보 삭제를 원하시면 아래 문의처로 요청해 주세요. 관계 법령에 따라
          별도 보존이 필요한 정보가 있는 경우, 해당 법령에서 정한 기간 동안 보관 후 파기합니다.
        </p>
      </section>
      ...
      <section className="mb-7">
        ...
        <p>
          ...
          사이드바 하단의 &quot;로그아웃&quot; 버튼을 이용해 주세요. 개인정보 삭제 또는 회원 탈퇴
          요청은 아래 문의처로 연락해 주시면 확인 후 처리해 드립니다.
        </p>
      </section>
